...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            logging.debug('Starting to clear existing data...')
            User.objects.all().delete()
            Team.objects.all().delete()
            Activity.objects.all().delete()
            Leaderboard.objects.all().delete()
            Workout.objects.all().delete()
            logging.debug('Existing data cleared.')
            ...
            logging.debug('Activities created.')
            ...
            logging.debug('Leaderboard entries created.')
            ...
            logging.debug('Workouts created.')
